...
export default function AdminLoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#1F3B2C] px-4">
      <div className="w-full max-w-sm bg-[#FAF7F0] rounded-2xl p-8 shadow-xl">
        <p className="uppercase tracking-[0.2em] text-[#7A2E2E] text-xs mb-2 text-center font-extrabold">
          Staff Access
        </p>
        <h1 className="font-display text-2xl font-semibold text-[#1F3B2C] text-center mb-6">
          Celebration Food Cafe
        </h1>

        {error && (
          <div className="bg-red-100 border border-red-300 text-red-800 text-xs p-3 rounded-md mb-4 leading-relaxed font-medium">
            {error}
          </div>
        )}
        ...
        <button
          ...
          className="w-full bg-white text-[#2A2622] border border-gray-300 hover:bg-gray-50 font-medium py-2.5 px-4 rounded-md transition flex items-center justify-center gap-3 cursor-pointer text-sm shadow-xs"
        >
